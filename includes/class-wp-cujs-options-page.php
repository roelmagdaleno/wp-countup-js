<<<<<<< develop:includes/class-wp-countup-js-options-page.php
<?php
...
if ( ! class_exists( 'WP_CUJS_Options_Page' ) ) {
	/**
	 * Create the plugin options page.
	 *
	 * @since  4.0.0
	 */
	class WP_CUJS_Options_Page {
		/**
		 * Set the required actions to create the
		 * options page.
		 *
...
>>>>>>> IMPROVE: Namings were simplified. JS files are loaded when shortcode is called.:includes/class-wp-cujs-options-page.php
