<<<<<<< develop:admin/views/class-wp-countup-js-settings.php
<?php
...
if ( ! class_exists( 'WP_CUJS_Settings' ) ) {
	/**
	 * Create the respective plugin settings.
	 *
	 * @since  4.0.0
	 */
	class WP_CUJS_Settings {
		/**
		 * The plugin settings.
		 *
		 * @since  4.0.0
	...
	new WP_CUJS_Settings();
}
>>>>>>> IMPROVE: Namings were simplified. JS files are loaded when shortcode is called.:includes/class-wp-cujs-settings.php
